...
var targetVpnGatewaysAdditionalFields = map[string]string{}
...
func (g TargetVpnGatewaysGenerator) createResources(ctx context.Context, targetVpnGatewaysList *compute.TargetVpnGatewaysListCall) []terraform_utils.Resource {
...
func (g *TargetVpnGatewaysGenerator) InitResources() error {
	...
	targetVpnGatewaysList := computeService.TargetVpnGateways.List(g.GetArgs()["project"].(string), g.GetArgs()["region"].(string))
