...
func (g RoutersGenerator) createResources(ctx context.Context, routersList *compute.RoutersListCall) []terraform_utils.Resource {
...
func (g *RoutersGenerator) InitResources() error {
	...
	routersList := computeService.Routers.List(g.GetArgs()["project"].(string), g.GetArgs()["region"].(string))
